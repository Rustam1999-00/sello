    ...
    const fetchData = async () => {
      try {
        ...
        const responseDiscount = await fetch(
          "http://157.230.2.35/api/subcategory"
        );
          ...
          <div className="body_Wrapper">
            <form className="pl-8 mb-20 p-8" onSubmit={handleSubmit}>
              ...
              <div className="ml-auto">
                <button
                  className="w-80 h-12 text-center text-white submit rounded-lg "
                  style={{ backgroundColor:'#2eb4ae' }}
                  type="submit"
                >
                  Submit
                </button>
            ...
            <div className="p-8">
              <div className=" mb-8">
                <h2 className="form_title pl-8 fount ">Our subcategories</h2>
              </div>
